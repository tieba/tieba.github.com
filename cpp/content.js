infos=[
	{name:"本吧管理组",id:"admins",init:fill_admin,content:[
		["吧主",['飞翔的天地','关签','御坂美琴みさか']],
		["小吧",['陆umj','幻の上帝','夜雨の离殇','寒云似雾','一群牛跑过','ZD_Tinson','RichSelian','EAgleLeo','LH_Mouse_Ex','NEMESIS_T2','白晓生锄禾','各大水神','wsfxzxb','vture','⑨chu','戈尔_Gore','小小的KEIS','Infinity_X','LarryGoode','介个名字很威武','NinsunClosear','lxy_lixiaoyan','星月and圣冰雨','SunnyCase','四元飒','★不死鸟之翼★','sunchy12345678','我是不是师兄','Padme0Amidala']],
		["小编",['一群牛跑过','菲西卡斯']],
	],expanding:true},
	{name:"本吧吧规",id:"rules",init:fill_rule,content:[
		...
		['吧务管理',
			...
			'2.5 吧务应删除构成违规行为的内容；或在存在充分理由时，指出违规后予以保留。',
		...
		['禁止事项',
			'4.1 以下按照内容可以明确判断的行为无条件视为违规行为：作弊；伸手（无偿要求解答问题且没有给出自身尝试解决问题的过程）；侵权；不文明言行（包括ID中出现侮辱性称谓的）；吧务调解无效、无视警告仍然继续的争吵。',
			'4.2 以下行为视为违规行为，除非提前通知并得到吧务批准：拜师；对非精品主题的挖坟；广告；使用仿冒吧务的ID；标题长度不大于2个字符的主题贴；贴子标题故意出现吸引目光的字符（如火星文）；贴子标题或内容出现大片重复或无意义文本；要求回复留邮箱或 QQ 等联系方式来分享资源的；回复邮箱或 QQ 等联系方式试图获取资源的。',
	...
	{name:"人物简介&马甲",init:fill_person,content:[
		...
		["凤凰院红旗/赫斯珀洛斯/万能姫/战地3/北斗/五行","水货一枚[<a href=\"https://github.com/HououinRedflag\" target=\"_blank\">HououinRedflag</a>]"],
		["Coding狂人","好似很久以前被气走了"],
		["阿宾和白洁","已经彻底坏掉了"],
