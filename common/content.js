common_info={
	contact:{name:"友情贴吧&联络方式",id:"contacts",init:fill_info,content:[
	...
	books:{name:"书籍简介",id:"books",init:fill_node,content:[
