infos=[
	...
	{name:"关于操作系统[仅参考]",init:fill_info,content:[
		["http://www.kernel.org/","Linux","某只内核<-是'内核'不是'操作系统'"],
		["","GNU/Debian",""],
		["","LinuxMint",""],
		["","FreeBSD",""],
		["","NetBSD",""],
	...
	{name:"集成开发环境(IDE)/编译器(Compiler)/编辑器(Editor)",init:fill_info,content:[
		["http://baike.baidu.com/view/14867.htm","<font style=\"color:#F60;\">集成开发环境:</font>","Integrated Development Environment"],
