rules=[
	...
	],['<font style="color:orange">正在改版，一下为原吧规及将合并的吧规</font>'
	],['以下内容可能被[删贴|封禁|黑名单]',
...
function load_rule(div){
	for(var i=0;i<rules.length;++i){
		div.append('<h4>'+rules[i][0]+'</h4>'+rules[i].slice(1).map(function(s){return "&nbsp;&nbsp;&nbsp;&nbsp;"+s+"<br>";}).join("")+"<br>");
	}
}
...
infos=[
	...
	{name:"人物简介&马甲",init:fill_person,content:[
		["RichTextBox/RichSelian/EGG娘","ROX-滚床压缩肉牛[<a href=\"https://github.com/richox\" target=\"_blank\">richox</a>]<sub>妹纸：@NailesHcir</sub>"],
