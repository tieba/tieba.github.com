rules=[
	...
	['总则',
		...
		'1.2 本吧规适用于<b>百度C++吧（以下称“本吧”）</b>，自公布即日起施行。',
		'1.3 请自觉遵守百度贴吧协议。',
		'1.4 注意言行，尊重他人就是善待自己。',
	...
	['吧务管理',
		'2.1 <i>吧务</i>（吧主和小吧主）按《百度贴吧吧主制度》和本吧规行使管理本吧的职权。本吧也欢迎其他吧友协助吧务进行管理，共同维护良好的讨论秩序。',
	...
	['讨论形式',
		...
		'3.1 本吧主题为C++及其它程序设计、软件开发、计算机科学和基础学科的一般话题，包括但不限于疑问求助、技术讨论、书籍评论、成果展示、行业新闻等。',
	...
	div.append(
		'<table width="100%" class="section_content"><tbody>'+
			'<tr valign="top"><td width="40px" align="left">吧主:</td><td>'+
				['飞翔的天地','关签','御坂美琴みさか'].map(lnk).join(" ")+
			'</td></tr>'+
			'<tr valign="top"><td width="40px" align="left">小吧:</td><td>'+
				[
					'一群牛跑过','ZD_Tinson','RichSelian','EAgleLeo','LH_Mouse_Ex'
					,'NEMESIS_T2','夜雨の离殇','寒云似雾','幻の上帝','陆umj'
				].map(lnk).join(" ")+
			'</td></tr>'+
			'<tr valign="top"><td width="40px" align="left">小编:</td><td>'+
				['一群牛跑过','菲西卡斯'].map(lnk).join(" ")+
			'</td></tr>'+
		'</tbody></table>'
		)
}
...
infos=[
	...
	{name:"人物简介&马甲",init:fill_person,content:[
		["幻の上帝/FrankHB","圆滚滚的工口帝球葱"],
		["飞翔的天地",""],
		["RichTextBox/RichSelian/EGG娘","ROX-滚床压缩肉牛<sub>妹纸：@NailesHcir</sub>"],
		["Hope_20121221_","某个小正太"],
		...
		["傻渡娘",""],
		["jingyingbox",""],
		["_craftG/良化纲领_/阎魔抽/serviper/九头一存/帕斯科维/H之读姬/Razielize/oxdead/Raptor酱/扯蛋的Aria/Xenoneee/九重束风景/攻城尸_/万能姬/守尸神主/...","羊驼-最近不知为何一直在强撸<sub>妹纸：@菲西卡斯</sub>"],
		["china_gll",""],
		["User32","被揉坏掉了的冰凉小脸"],
		["萧の十三郎",""],
		["风之追梦者/梅汁追求者",""],
